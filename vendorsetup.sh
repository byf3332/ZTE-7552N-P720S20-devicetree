...
patch -d "${_p720s20_android_top}/bootable/recovery" -p1 \
    < "${_p720s20_tree_dir}/patches/unisoc_mtp_ffs_v1.patch" || return 1
...
python3 "${_p720s20_tree_dir}/tools/install_p720s20_usb_otg_ui.py" \
    "${_p720s20_android_top}/bootable/recovery/partition.cpp" \
    "${_p720s20_android_top}/bootable/recovery/partitionmanager.cpp" || return 1
python3 "${_p720s20_tree_dir}/tools/install_p720s20_fastbootd_storage_ui.py" \
    "${_p720s20_android_top}/bootable/recovery/partitionmanager.cpp" || return 1
